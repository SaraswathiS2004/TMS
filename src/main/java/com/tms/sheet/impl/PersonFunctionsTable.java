...
public class PersonFunctionsTable extends AbstractDBTable {

    private static final List<String> HEADERS = List.of("PERSON_ID", "FUNCTION_ID", "INVITED_STATUS");

    @Override
    public String getTableName() {
        return "Person_Functions";
    }
    ...
    public List<List<Object>> fetchAllRows(Connection conn) throws SQLException {
        ResultSet rs = conn.prepareStatement(
            "SELECT PERSON_ID, FUNCTION_ID, INVITED_STATUS FROM Person_Functions ORDER BY PERSON_ID, FUNCTION_ID"
        ).executeQuery();
